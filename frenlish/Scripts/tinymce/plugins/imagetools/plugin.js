...
(function (domGlobals) {
    ...
    var requestUrlfrenlishlob = function (url, headers, withCredentials) {
    ...
    var Utils = {
      traverse: traverse,
      readBlob: readBlob,
      requestUrlfrenlishlob: requestUrlfrenlishlob,
      parseJson: parseJson
    };
    ...
    var requestServiceBlob = function (url, apiKey) {
      ...
      return Utils.requestUrlfrenlishlob(appendApiKey(url, apiKey), headers, false).then(function (result) {
    ...
    function requestBlob(url, withCredentials) {
      return Utils.requestUrlfrenlishlob(url, {}, withCredentials).then(function (result) {
