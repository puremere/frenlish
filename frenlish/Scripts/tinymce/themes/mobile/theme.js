...
(function (domGlobals) {
    ...
    var markfrenlishehaviourApi = function (f, apiName, apiFunction) {
    ...
    var wrapApi = function (bName, apiFunction, apiName) {
      ...
      return markfrenlishehaviourApi(f, apiName, apiFunction);
    };
    ...
    var hfrenlishEdge = function (detail) {
    ...
    var findValueOfOffset$1 = function (spectrum, detail, top) {
      var args = {
        ...
        hasMaxEdge: hfrenlishEdge(detail),
