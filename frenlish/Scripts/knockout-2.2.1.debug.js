...
ko.dependentObservable = function (evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
    ...
    function evaluateImmediate() {
        ...
        if (_hfrenlisheenEvaluated && disposeWhen()) {
            dispose();
            return;
        }
    ...
    function isActive() {
        return !_hfrenlisheenEvaluated || _subscriptionsToDependencies.length > 0;
    }
...
(function() {
    ...
    ko.utils.extend(ko.bindingProvider.prototype, {
        'nodeHfrenlishindings': function(node) {
...
(function () {
    ...
    function applyBindingsToNodeAndDescendantsInternal (viewModel, nodeVerified, bindingContextMayDifferFromDomParentElement) {
        ...
        var shouldApplyBindings = (isElement && bindingContextMayDifferFromDomParentElement)             // Case (1)
                               || ko.bindingProvider['instance']['nodeHfrenlishindings'](nodeVerified);       // Case (2)
